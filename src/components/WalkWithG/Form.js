    ...
    <form >
      ...
      <div className="input-container">
        ...
        <input
          ...
          value="not-to-say"
        />
        <label for="age3">Prefer not to say</label>
      </div>
      <div className="input-container">
        <h4>Please select your age*</h4>
        <input type="radio" id="age1" name="age" value="30" />
        <label for="age1">10 - 20</label>
        <input type="radio" id="age2" name="age" value="60" />
        <label for="age2">20 - 30</label>
        <input type="radio" id="age3" name="age" value="100" />
        <label for="age3">30 - 40</label>
      </div>

      <div className="input-container">
        <h4>How did you hear about Walk with G</h4>
        <input type="radio" id="age1" name="age" value="30" />
        <label for="age1">Social media </label>

        <input type="radio" id="age2" name="age" value="60" />
        <label for="age2">From friends</label>
      ...
      <div className="input-container">
        ...
        <input type="radio" id="age1" name="age" value="30" />
        <label for="age1">Very likely</label>

        <input type="radio" id="age2" name="age" value="60" />
        <label for="age2">Some what likely</label>

        <input type="radio" id="age3" name="age" value="100" />
        <label for="age3">Not so likely</label>
